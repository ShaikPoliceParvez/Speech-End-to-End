...
try:
    ...
    try:
        # Preferred package import in the current project layout.
        from stt.indic_stt import StreamingIndicTranscriber as _IndicStreamer
    except ImportError:
        # Backward-compatible import for legacy flat layouts.
...
class STT:
    ...
    def _script_matches_language(language, script):
        ...
        expected_scripts = {
            ...
            "ne": {"devanagari", "latin", "mixed", "unknown"},
    ...
    def _roman_language(text):
        ...
        scores = {
            ...
            "ne": sum(token in NEPALI_ROMAN_CORE_WORDS for token in tokens),
        ...
        if needs_retry:
            ...
            if script == "devanagari":
                ...
                if roman_language == "hi":
                    candidates = ("hi", "en")
                elif roman_language == "ne":
                    candidates = ("ne", "hi", "en")
                else:
                    candidates = (roman_language, "en")
            elif detected_language in ("hi", "ne"):
                candidates = (detected_language, "en")
            elif script == "telugu":
